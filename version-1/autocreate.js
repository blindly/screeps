...
var autocreate = {
    ...
    run: function(Game, allowCreepCreation) {
        ...
        var roles = [{
            ...
            name: 'alt_harvester',
            group: 'alt_harvesters',
            priority: 2,
            max: 4,
            count: _.filter(Game.creeps, (creep) => creep.memory.role == 'alt_harvester').length
        }, {
            name: 'upgrader',
            group: 'upgraders',
            priority: 3,
            ...
            priority: 5,
            max: 4,
            count: _.filter(Game.creeps, (creep) => creep.memory.role == 'alt_upgrader').length
        }];
